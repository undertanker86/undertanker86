...
👨‍💻 Featured projects
1. Vello Website:
   - Front-end: https://github.com/undertanker86/Project-Vello-Web-Trello-Website-
   - Back-end: https://github.com/undertanker86/Vello-API
   - Deploy FE: https://vello-f86t.onrender.com
   - Deploy BE: https://vello-api.onrender.com
   - My role: Full-stack
3. TinyURL with Microservice
   - OCR Model Service: https://github.com/undertanker86/ocr-model
   - Authentication Service: https://github.com/undertanker86/auth-api
   - URL Service & API Gateway: https://github.com/undertanker86/api-amd
   - My role: Back-end, Dockerization.
